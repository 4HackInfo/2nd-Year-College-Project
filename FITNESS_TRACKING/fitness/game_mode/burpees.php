...
<head>
    ...
    <title>BURPEESE CHALLENGE</title>
    ...
    <style>
        ...
        .burpees-clock img:hover,  .burpees-roll img:hover{
...
<div class="game-mode-container">
        ...
        <div class="burpees-clock" onclick="navigateTo('burpees/burpees_clock.php')">
            <img src="burpees_clock.png" alt="clock-play" class="image">
        </div>

        <div class="burpees-roll" onclick="navigateTo('burpees/burpees_roll.php')">
             <img src="burpees_roll.png" alt="roll-play" class="image">
        </div>  
