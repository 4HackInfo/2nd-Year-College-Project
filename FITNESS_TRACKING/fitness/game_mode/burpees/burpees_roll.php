...
<body>
    ...
    <div class="container">
        ...
        <p>Roll a dice to determine how many seconds/minutes you will do</p>
...
<div id="floatingPlayer" class="floating-player collapsed">
    ...
    <script>
        ...
        function rollDice() {
            ...
            seconds = roll * 10;  // 10 seconds per dice face value (e.g., roll 1 => 10 sec, roll 6 => 60 sec)
            document.getElementById("diceImage").src = `dice-${roll}.png`;

            let resultDiv = document.getElementById("result");
            resultDiv.innerHTML = `You rolled a ${roll}!<br>Do burpees for ${seconds} seconds!`;
            ...
            timerInterval = setInterval(() => {
                ...
                if (current > 0) {
                    ...
                    updatePoints(roll); // Update points once the timer ends
                }
            }, 1000);
        }

        function updatePoints(roll) {
            // Calculate points based on the dice roll
            let points = roll * 10; // Example: 10 points per dice value
