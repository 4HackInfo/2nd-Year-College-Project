...
<head>
    ...
    <style>
        ...
        .push-up-clock img:hover{
            border: 1px solid white;
            border-radius: 10px;
        }
        .push-up-roll img:hover{
            border: 1px solid white;
            border-radius: 10px;
        }
...
<div class="game-mode-container">
        ...
        <div class="push-up-clock" onclick="navigateTo('push-up/push_up_clock.php')">
            <img src="push_up_clock.png" alt="clock-play" class="image">
        </div>
        
        <div class="push-up-roll" onclick="navigateTo('push-up/push_up_roll.php')">
             <img src="push_up_roll.png" alt="roll-play" class="image">
        </div>
</div>
