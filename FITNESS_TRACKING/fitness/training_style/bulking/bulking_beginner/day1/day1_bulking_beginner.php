...
<div class="back-button" onclick="navigateTo('../bulking_beginner.php')">
  ...
  <div class="container" id="mainPage">
    <div class="header">
      <h2>DAY 1</h2>
      <p class="sub-header">Bulking | Beginner
      </p>
    </div>
    ...
    <div class="task-list">
      ...
      <div class="task"><img src="diamond_pushup.jpg" alt=" Diamond_Push_Up"><div class="task-details"><h4> DIAMOND PUSH UP</h4><span>x12</span></div></div>
      <div class="task"><img src="close_grip_pushup.jpg" alt="Incline Push Up"><div class="task-details"><h4>CLOSE GRIP PUSH UP</h4><span>x12</span></div></div>
      <div class="task"><img src="chin_up_hold.jpg" alt="Chin Up Hold"><div class="task-details"><h4>CHIN UP HOLD</h4><span>30 seconds</span></div></div>
      <div class="task"><img src="wrist_stretch.jpg" alt="Wrist Flexor Stretch "><div class="task-details"><h4>WRIST FLEXOR STRETCH </h4><span>30 seconds</span></div></div>
      <div class="task"><img src="tricep_dips.jpg" alt="Tricep Dips"><div class="task-details"><h4>TRICEP DIPS</h4><span>x12</span></div></div>
      <div class="task"><img src="diamond_pushup.jpg" alt=" Diamond_Push_Up"><div class="task-details"><h4> DIAMOND PUSH UP</h4><span>x12</span></div></div>
      <div class="task"><img src="close_grip_pushup.jpg" alt="Incline Push Up"><div class="task-details"><h4>CLOSE GRIP PUSH UP</h4><span>x12</span></div></div>
      <div class="task"><img src="chin_up_hold.jpg" alt="Chin Up Hold"><div class="task-details"><h4>CHIN UP HOLD</h4><span>30 seconds</span></div></div>
      <div class="task"><img src="wrist_stretch.jpg" alt="Wrist Flexor Stretch "><div class="task-details"><h4>WRIST FLEXOR STRETCH </h4><span>30 seconds</span></div></div>
...
<div id="floatingPlayer" class="floating-player collapsed">
  ...
  <script>
    ...
    const animations = {
      ...
      "Jumping Jacks 30 seconds": "jumping_jack.gif",
      "Diamond Push Up x12": "Diamond_Push-Up_GIF.gif",
      "Close Grip Push Up x12": "close_grip_pushup.gif",
      "water break" : "water_break.png",
      "Chin up Hold 30 seconds" : "chin_up_hold.gif",
      "Wrist Flexor Stretch 30 seconds": "wrist_stretch.gif",
      "Tricep Dips x12": "tricep_dips.gif",
      "water break": "water_break.png",
      "Diamond Push Up x12": "Diamond_Push-Up_GIF.gif",
      "Close Grip Push Up x12": "close_grip_pushup.gif",
      "Chin up Hold 30 seconds" : "chin_up_hold.gif",
      ...
      "Wrist Flexor Stretch 30 seconds": "wrist_stretch.gif",
      "Tricep Dips x12": "tricep_dips.gif",
      "Cobra Stretch 30 seconds": "cobra_stretch.gif"
    };
