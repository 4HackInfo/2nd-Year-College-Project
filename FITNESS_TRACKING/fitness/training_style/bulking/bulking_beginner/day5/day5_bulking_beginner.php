...
<div class="back-button" onclick="navigateTo('../bulking_beginner.php')">
  ...
  <div class="container" id="mainPage">
    <div class="header">
      <h2>DAY 3</h2>
      <p class="sub-header">Bulking | Beginner</p>
    </div>
    <button class="start-button" onclick="startWorkout()">START</button>

    <div class="task-list">
      <div class="task"><img src="plank.png" alt="Planks"><div class="task-details"><h4>PLANK</h4><span>45 seconds</span></div></div>
      <div class="task"><img src="mountain_climber.jpg" alt=" MOUNTAIN CLIMBERS"><div class="task-details"><h4> MOUNTAIN CLIMBERS</h4><span>x20</span></div></div>
      <div class="task"><img src="russian_twist.png" alt="RUSSIAN TWIST"><div class="task-details"><h4>RUSSIAN TWIST</h4><span>x20</span></div></div>
      <div class="task"><img src="reverse_crunch.jpg" alt="REVERSE CRUNCHES"><div class="task-details"><h4>REVERSE CRUNCHES</h4><span>x15</span></div></div>
      <div class="task"><img src="leg_raises.png" alt="LEG RAISES "><div class="task-details"><h4>LEG RAISES</h4><span>x12</span></div></div>
      <div class="task"><img src="bicycle_crunches.jpg" alt="BICYCLE CRUNCHES"><div class="task-details"><h4>BICYCLE CRUNCHES</h4><span>x20</span></div></div>
      <div class="task"><img src="plank.png" alt="Planks"><div class="task-details"><h4>PLANK</h4><span>45 seconds</span></div></div>
      <div class="task"><img src="mountain_climber.jpg" alt=" MOUNTAIN CLIMBERS"><div class="task-details"><h4> MOUNTAIN CLIMBERS</h4><span>x20</span></div></div>
      <div class="task"><img src="russian_twist.png" alt="RUSSIAN TWIST"><div class="task-details"><h4>RUSSIAN TWIST</h4><span>x20</span></div></div>
      <div class="task"><img src="reverse_crunch.jpg" alt="REVERSE CRUNCHES"><div class="task-details"><h4>REVERSE CRUNCHES</h4><span>x15</span></div></div>
...
<div id="floatingPlayer" class="floating-player collapsed">
  ...
  <script>
    ...
    const animations = {
        ...
        "Plank 45 seconds": "planking.gif",
        "Mountain Climbers x20": "mountain_climber.gif",
        "Russian Twist x20": "russian_twist.gif",
        "Water Break": "water_break.png",
        "Reverse Crunches x15": "reverse_crunches.gif",
        "Leg Raises x12": "leg_raises.gif",
        "Bicycle Crunches x20": "bicycle_crunches.gif",
        "Water Break": "water_break.png",
        "Plank 45 seconds": "planking.gif",
        "Mountain Climbers x20": "mountain_climber.gif",
        "Russian Twist x20": "russian_twist.gif",
