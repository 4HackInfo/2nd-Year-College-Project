...
<div class="back-button" onclick="navigateTo('../bulking_intermediate.php')">
  ...
  <div class="container" id="mainPage">
    ...
    <div class="task-list">
      <div class="task"><img src="bodyweight_squats.jpg" alt="Bodyweight Squats"><div class="task-details"><h4>BODYWEIGHT SQUATS</h4><span>x18</span></div></div>
      <div class="task"><img src="bulgarian_splits.jpg" alt="Bulgarian Splits Squats"><div class="task-details"><h4>BULGARIAN SPLITS SQUADS</h4><span>x8 per leg</span></div></div>
      <div class="task"><img src="glute_bridges.jpg" alt="Glute Bridges"><div class="task-details"><h4>GLUTE BRIDGES</h4><span>x18</span></div></div>
      <div class="task"><img src="wall_sit.jpg" alt="Wall Sit"><div class="task-details"><h4>WALL SIT</h4><span>45 seconds</span></div></div>
      <div class="task"><img src="calf_raises.jpg" alt="Calf Raises"><div class="task-details"><h4>CALF RAISES</h4><span>45 seconds</span></div></div>
      <div class="task"><img src="bodyweight_squats.jpg" alt="Bodyweight Squats"><div class="task-details"><h4>BODYWEIGHT SQUATS</h4><span>x18</span></div></div>
      <div class="task"><img src="bulgarian_splits.jpg" alt="Bulgarian Splits Squats"><div class="task-details"><h4>BULGARIAN SPLITS SQUADS</h4><span>x8 per leg</span></div></div>
      <div class="task"><img src="glute_bridges.jpg" alt="Glute Bridges"><div class="task-details"><h4>GLUTE BRIDGES</h4><span>x18</span></div></div>
      <div class="task"><img src="wall_sit.jpg" alt="Wall Sit"><div class="task-details"><h4>WALL SIT</h4><span>45 seconds</span></div></div>
...
<div id="floatingPlayer" class="floating-player collapsed">
  ...
  <script>
    const tasks = [
      ...
      "Bulgarian Splits Squads x8 per leg",
      " Glute Bridges x18",
      "Wall Sit 45 seconds",
      "water_break",
    ...
    const animations = {
      ...
      "Bodyweight Squats x18" : "bodyweight_squats.gif",
      "Bulgarian Splits Squads x8 per leg" : "bulgarian_splits.gif",
      "Glute Bridges x18" : "glute_bridges.gif",
      "Wall Sit 45 seconds" : "wall_sit.gif",
      "water_break" : "water_break.png",
      "Calf Raises 45 seconds" : "calf_raises.gif",
      "Bodyweight Squats x18" : "bodyweight_squats.gif",
      "Bulgarian Splits Squads x8 per leg" : "bulgarian_splits.gif",
      "water_break" : "water_break.png",
      "Glute Bridges x18" : "glute_bridges.gif",
