...
<title>Cardio Intermediate</title>
...
<div class="back-button" onclick="navigateTo('../cardio_selection.php')">
  <img src="../../back.png" alt="back_button-icon">
</div>

<div class="main-container">
<h1>CARDIO</h1>
<h3>INTERMEDIATE (7 x 4)</h3>
...
let data = JSON.parse(localStorage.getItem("cardio_intermediate_progress")) || defaultData;

function saveData() {
  localStorage.setItem("cardio_intermediate_progress", JSON.stringify(data));
}
...
function createDayCard(dayNum) {
  ...
  if (!isUnlockedDay && !isVisited) {
    ...
    img.src = (dayNum % 2 === 0) ? "rest.png" : "workout7.png";
  }
  ...
  card.onclick = () => {
    ...
    window.location.href = `day${dayNum}/day${dayNum}_cardio_intermediate.php`;
};
...
localStorage.removeItem("cardio_intermediate_progress");
location.reload();
}
</script>
