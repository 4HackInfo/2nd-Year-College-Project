...
<div class="back-button" onclick="navigateTo('../cutting_advanced.php')">
  ...
  <div class="container" id="mainPage">
    ...
    <div class="task-list">
      ...
      <div class="task"><img src="push_up.png" alt="Push Up"><div class="task-details"><h4>PUSH UP</h4><span>x10</span></div></div>
      <div class="task"><img src="incline_push_up.png" alt="Incline Push Up"><div class="task-details"><h4>INCLINE PUSH UP</h4><span>x10</span></div></div>
      <div class="task"><img src="knee_push_up.png" alt="Knee Push Up"><div class="task-details"><h4>KNEE PUSH UP</h4><span>x10</span></div></div>
      <div class="task"><img src="widearm_push_up.png" alt="Wide Arm Push Up"><div class="task-details"><h4>WIDE ARM PUSH UP</h4><span>x10</span></div></div>
      <div class="task"><img src="push_up.png" alt="Push Up Again"><div class="task-details"><h4>PUSH UP</h4><span>x10</span></div></div>
      <div class="task"><img src="incline_push_up.png" alt="Incline Push Up Again"><div class="task-details"><h4>INCLINE PUSH UP</h4><span>x10</span></div></div>
      <div class="task"><img src="knee_push_up.png" alt="Knee Push Up Again"><div class="task-details"><h4>KNEE PUSH UP</h4><span>x110</span></div></div>
      <div class="task"><img src="widearm_push_up.png" alt="Wide Arm Again"><div class="task-details"><h4>WIDE ARM PUSH UP</h4><span>x10</span></div></div>
...
<div id="floatingPlayer" class="floating-player collapsed">
  ...
  <script>
    ...
    const animations = {
      ...
      "Push Up x10": "push_up.gif",
      "Incline Push Up x10": "incline_push_up.gif",
      "Water break" : "",
      "Knee Push Up x10": "knee_push_up.gif",
      "Wide Arm Push Up x10": "widearm_push_up.gif",
      "Water break" : "",
      "Push Up x10": "push_up.gif",
      "Incline Push Up x10": "incline_push_up.gif",
      "Knee Push Up x10": "knee_push_up.gif",
