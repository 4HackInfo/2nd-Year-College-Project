...
<div class="back-button" onclick="navigateTo('../cutting_intermediate.php')">
  ...
  <div class="container" id="mainPage">
    ...
    <div class="task-list">
      <div class="task"><img src="jumping_jacks.png" alt="jumping jack"><div class="task-details"><h4>Jumping Jacks</h4><span>35 seconds</span></div></div>
      <div class="task"><img src="abdominal_crunches.png" alt="crunches"><div class="task-details"><h4>Abdominal Crunches</h4><span>x 16</span></div></div>
      ...
      <div class="task"><img src="plank.png" alt="plank man"><div class="task-details"><h4>Planking </h4><span>35 seconds</span></div></div>
      <div class="task"><img src="leg_raises.png" alt="leg_raises"><div class="task-details"><h4>Leg Raises</h4><span> x 14</span></div></div>
      <div class="task"><img src="abdominal_crunches.png" alt="abdominal_crunches"><div class="task-details"><h4>Abdominal Crunches</h4><span> x 16</span></div></div>
      <div class="task"><img src="russian_twist.png" alt="russian_twist"><div class="task-details"><h4>Russian Twist</h4><span> x 14</span></div></div>
      <div class="task"><img src="plank.png" alt="plank man"><div class="task-details"><h4>Planking </h4><span>35 seconds</span></div></div>
      <div class="task"><img src="leg_raises.png" alt="leg_raises"><div class="task-details"><h4>Leg Raises</h4><span> x 14</span></div></div>
      <div class="task"><img src="cobra_stretch.png" alt="cobra_stretch"><div class="task-details"><h4>Cobra Stretch</h4><span>35 seconds</span></div></div>
    </div>
  </div>
...
<div id="floatingPlayer" class="floating-player collapsed">
  ...
  <script>
    const tasks = [
      ...
      "Planking 35 seconds",
      "Leg Raises x14",
      "Cobra Stretch 35 seconds",
    ];

    const animations = {
      "Jumping Jacks 35 seconds" : "jumping_jack.gif",
      "Abdominal Crunches x16" : "abdominal_crunches.gif",
      "Russian Twist x14" : "russian_twist.gif", 
      "Water Break" :  "water_break.png ",
      "Planking 35 seconds" : "planking.gif",
      "Leg Raises x14" : "leg_raises.gif",
      "Abdominal Crunches x16" : "abdominal_crunches.gif",
      "Water Break" :  "water_break.png ",
      "Russian Twist x14" : "russian_twist.gif",
      "Planking 35 seconds" : "planking.gif",
      "Leg Raises x14" : "leg_raises.gif",
      "Cobra Stretch 35 seconds" : "cobra_stretch.gif",
    };
